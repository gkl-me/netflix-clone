...
import '../App.css'
import { TitleCardType,Movie } from '../Types/Types';
import { Link } from 'react-router-dom';
import info_icon from '../assets/info_icon.png'
import play_icon from '../assets/play_icon.png'

const CardLists:React.FC<TitleCardType> = ({title,category}) => {
  ...
  return (
    <div className="pl-[4%] py-4 relative group">
      <h1 className="text-2xl font-bold mb-5 text-white">{title?title:""}</h1>
      <div ref={scrollRef} className="scroll flex space-x-4 overflow-x-scroll scrollbar-hidden pb-6 ">
      ...
      <button
       ...
       className='hidden group-hover:block absolute left-14 top-32 h-10 w-10 z-[1] bg-black'>
